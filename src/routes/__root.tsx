    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--background)] px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-lg bg-[var(--primary)] px-4 py-2.5 text-sm font-medium text-[var(--primary-foreground)] shadow-sm transition-all hover:bg-[var(--primary)]/90"
          >
            Go home
          </Link>
        </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--background)] px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-lg border border-[var(--input)] bg-[var(--card)] px-4 py-2 text-sm font-medium text-[var(--foreground)] transition-colors hover:bg-[var(--accent)]"
          >
            Go home
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NetSage — Adaptive Network Configuration Compliance" },
      {
        name: "description",
        content:
          "Enterprise multi-vendor network configuration compliance & AI-assisted security analysis platform.",
      },
      { name: "author", content: "NetSage" },
      { property: "og:title", content: "NetSage — Network Configuration Compliance" },
      {
        property: "og:description",
        content: "Enterprise multi-vendor network configuration compliance platform.",
      },
